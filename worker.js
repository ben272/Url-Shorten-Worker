...
let index_html = "https://ben272.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
let result_html = "https://ben272.github.io/Url-Shorten-Worker/" + config.theme + "/result.html"
...
const html404 = `<!DOCTYPE html>
  ...
  <body>
    ...
    <p> <a href="https://github.com/ben272/Url-Shorten-Worker/" target="_self">Fork me on GitHub</a> </p>
  </body>
  </html>`
...
async function handleRequest(request) {
  ...
  if (!path) {
    return Response.redirect("https://bing.com/", 302)
